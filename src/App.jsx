...
import { migrateFromLocalStorage } from './lib/adapters/db'
import { ensureLocalDataConsistency } from './lib/adapters/LocalStorageAdapter'
...
export default function App() {
  ...
  const authLoading = useAuthStore((s) => s.isInitializing)
